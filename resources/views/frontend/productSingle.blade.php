...
<section class="home-slider owl-carousel">
      ...
      <div class="slider-item" style="background-image: url({{ asset('frontend/images/ps.jpg')}});" data-stellar-background-ratio="0.5">
    	...
    	<div class="container">
    		...
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="{{ asset('frontend/images/menu-2.jpg')}}" class="image-popup"><img src="{{$food->photo}}" class="img-fluid" alt="Colorlib Template"></a>
